...
<body>
    ...
    <a href="../signin&signup.php" class="signin_signup" style="text-transform: capitalize; font-size: 15px; color: #363A44; font-weight: 650; background: #fff; padding: 10px 15px 10px 15px;">Sign in/Sign up</a>
    <?php } else { ?>
